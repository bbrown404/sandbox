...
namespace CardShufflerTests
{
    ...
    public class DeckTestsNUnit
    {
        ...
        private static void AssertOrder(Deck target, bool ascending)
        {
            Card lastCard = null;
